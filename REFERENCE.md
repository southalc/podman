...
* [`podman::manage_container`](#podman--manage_container): Generate and manage podman container quadlet definition (podman > 4.4.0)
...
### <a name="podman--manage_container"></a>`podman::manage_container`

Generate and manage podman container quadlet definition (podman > 4.4.0)
...
The following parameters are available in the `podman::manage_container` defined type:

* [`ensure`](#-podman--manage_container--ensure)
* [`path`](#-podman--manage_container--path)
* [`owner`](#-podman--manage_container--owner)
* [`group`](#-podman--manage_container--group)
* [`mode`](#-podman--manage_container--mode)
* [`daemon_reload`](#-podman--manage_container--daemon_reload)
* [`active`](#-podman--manage_container--active)
* [`unit_entry`](#-podman--manage_container--unit_entry)
* [`install_entry`](#-podman--manage_container--install_entry)
* [`service_entry`](#-podman--manage_container--service_entry)
* [`container_entry`](#-podman--manage_container--container_entry)

##### <a name="-podman--manage_container--ensure"></a>`ensure`
...
##### <a name="-podman--manage_container--path"></a>`path`

Data type: `Enum['/etc/containers/systemd']`

Location to create container file in.

Default value: `'/etc/containers/systemd'`

##### <a name="-podman--manage_container--owner"></a>`owner`

Data type: `Enum['root']`

Owner of container file.

Default value: `'root'`

##### <a name="-podman--manage_container--group"></a>`group`

Data type: `Enum['root']`

Group of container file.

Default value: `'root'`

##### <a name="-podman--manage_container--mode"></a>`mode`
...
##### <a name="-podman--manage_container--daemon_reload"></a>`daemon_reload`

Data type: `Boolean`

Call `systemctl daemon-reload` to generate service file.

Default value: `true`

##### <a name="-podman--manage_container--active"></a>`active`
...
##### <a name="-podman--manage_container--unit_entry"></a>`unit_entry`
...
##### <a name="-podman--manage_container--install_entry"></a>`install_entry`
...
##### <a name="-podman--manage_container--service_entry"></a>`service_entry`
...
Struct[Optional['AddCapability'] => Array[String[1],1],
  ...
  Optional['Label'] => Array[String[1],0],
